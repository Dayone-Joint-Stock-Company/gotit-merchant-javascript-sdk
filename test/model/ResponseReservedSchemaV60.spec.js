...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerchantApis.ResponseReservedSchemaV60();
  });
  ...
  describe('ResponseReservedSchemaV60', function() {
    it('should create an instance of ResponseReservedSchemaV60', function() {
      // uncomment below and update the code to test ResponseReservedSchemaV60
      //var instance = new MerchantApis.ResponseReservedSchemaV60();
      //expect(instance).to.be.a(MerchantApis.ResponseReservedSchemaV60);
    });
