...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerchantApis.RequestCheckMultipleBodySchemaV60();
  });
  ...
  describe('RequestCheckMultipleBodySchemaV60', function() {
    it('should create an instance of RequestCheckMultipleBodySchemaV60', function() {
      // uncomment below and update the code to test RequestCheckMultipleBodySchemaV60
      //var instance = new MerchantApis.RequestCheckMultipleBodySchemaV60();
      //expect(instance).to.be.a(MerchantApis.RequestCheckMultipleBodySchemaV60);
    });
