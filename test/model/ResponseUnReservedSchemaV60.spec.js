...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerchantApis.ResponseUnReservedSchemaV60();
  });
  ...
  describe('ResponseUnReservedSchemaV60', function() {
    it('should create an instance of ResponseUnReservedSchemaV60', function() {
      // uncomment below and update the code to test ResponseUnReservedSchemaV60
      //var instance = new MerchantApis.ResponseUnReservedSchemaV60();
      //expect(instance).to.be.a(MerchantApis.ResponseUnReservedSchemaV60);
    });
