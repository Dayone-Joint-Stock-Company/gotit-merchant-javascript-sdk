...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerchantApis.RequestReservedBodySchemaV60();
  });
  ...
  describe('RequestReservedBodySchemaV60', function() {
    it('should create an instance of RequestReservedBodySchemaV60', function() {
      // uncomment below and update the code to test RequestReservedBodySchemaV60
      //var instance = new MerchantApis.RequestReservedBodySchemaV60();
      //expect(instance).to.be.a(MerchantApis.RequestReservedBodySchemaV60);
    });
