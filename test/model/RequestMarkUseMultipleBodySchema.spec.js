...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GotItMerchantSDK.RequestMarkUseMultipleBodySchema();
  });
  ...
  describe('RequestMarkUseMultipleBodySchema', function() {
    it('should create an instance of RequestMarkUseMultipleBodySchema', function() {
      // uncomment below and update the code to test RequestMarkUseMultipleBodySchema
      //var instance = new GotItMerchantSDK.RequestMarkUseMultipleBodySchema();
      //expect(instance).to.be.a(GotItMerchantSDK.RequestMarkUseMultipleBodySchema);
    });
