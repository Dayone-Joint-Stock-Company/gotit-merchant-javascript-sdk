...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerchantApis.RequestMarkUseMultipleBodySchema();
  });
  ...
  describe('RequestMarkUseMultipleBodySchema', function() {
    it('should create an instance of RequestMarkUseMultipleBodySchema', function() {
      ...
      //var instance = new MerchantApis.RequestMarkUseMultipleBodySchema();
      //expect(instance).to.be.a(MerchantApis.RequestMarkUseMultipleBodySchema);
    });
