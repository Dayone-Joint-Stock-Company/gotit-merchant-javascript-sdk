...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerchantApis.ResponseMarkUseMultipleSchemaV60();
  });
  ...
  describe('ResponseMarkUseMultipleSchemaV60', function() {
    it('should create an instance of ResponseMarkUseMultipleSchemaV60', function() {
      // uncomment below and update the code to test ResponseMarkUseMultipleSchemaV60
      //var instance = new MerchantApis.ResponseMarkUseMultipleSchemaV60();
      //expect(instance).to.be.a(MerchantApis.ResponseMarkUseMultipleSchemaV60);
    });
