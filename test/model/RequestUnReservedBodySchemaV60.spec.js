...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerchantApis.RequestUnReservedBodySchemaV60();
  });
  ...
  describe('RequestUnReservedBodySchemaV60', function() {
    it('should create an instance of RequestUnReservedBodySchemaV60', function() {
      // uncomment below and update the code to test RequestUnReservedBodySchemaV60
      //var instance = new MerchantApis.RequestUnReservedBodySchemaV60();
      //expect(instance).to.be.a(MerchantApis.RequestUnReservedBodySchemaV60);
    });
