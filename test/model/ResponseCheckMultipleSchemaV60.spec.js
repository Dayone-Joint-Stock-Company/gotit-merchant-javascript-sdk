...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerchantApis.ResponseCheckMultipleSchemaV60();
  });
  ...
  describe('ResponseCheckMultipleSchemaV60', function() {
    it('should create an instance of ResponseCheckMultipleSchemaV60', function() {
      // uncomment below and update the code to test ResponseCheckMultipleSchemaV60
      //var instance = new MerchantApis.ResponseCheckMultipleSchemaV60();
      //expect(instance).to.be.a(MerchantApis.ResponseCheckMultipleSchemaV60);
    });
