...
import ResponseReservedSchemaDataInner from './ResponseReservedSchemaDataInner';
...
class ResponseReservedSchema {
    /**
     * Constructs a new <code>ResponseReservedSchema</code>.
     * @alias module:model/ResponseReservedSchema
     */
    constructor() { 
        
        ResponseReservedSchema.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseReservedSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseReservedSchema} obj Optional instance to populate.
     * @return {module:model/ResponseReservedSchema} The populated <code>ResponseReservedSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseReservedSchema();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ResponseReservedSchemaDataInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseReservedSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseReservedSchema</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ResponseReservedSchemaDataInner.validateJSON(item);
            };
        }
 ...
 */
ResponseReservedSchema.prototype['success'] = undefined;

/**
 * Result code if failed. In case of successful request: value is null
 * @member {String} return_code
 */
ResponseReservedSchema.prototype['return_code'] = undefined;

/**
 * Message notification in English
 * @member {String} message_en
 */
ResponseReservedSchema.prototype['message_en'] = undefined;

/**
 * Message notification in Vietnamese
 * @member {String} message_vi
 */
ResponseReservedSchema.prototype['message_vi'] = undefined;

/**
 * @member {module:model/ResponseReservedSchemaUsedStore} used_store
 */
ResponseReservedSchema.prototype['used_store'] = undefined;

/**
 * Bill number
 * @member {String} bill_number
 */
ResponseReservedSchema.prototype['bill_number'] = undefined;

/**
 * Detail items of voucher, if result is failed, response will return the first voucher code which is invalid
 * @member {Array.<module:model/ResponseReservedSchemaDataInner>} data
 */
ResponseReservedSchema.prototype['data'] = undefined;
...
export default ResponseReservedSchema;
