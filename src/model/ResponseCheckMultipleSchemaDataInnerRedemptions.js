...
/**
 * The ResponseCheckMultipleSchemaDataInnerRedemptions model module.
 * @module model/ResponseCheckMultipleSchemaDataInnerRedemptions
 * @version 1.0.3
 */
class ResponseCheckMultipleSchemaDataInnerRedemptions {
    /**
     * Constructs a new <code>ResponseCheckMultipleSchemaDataInnerRedemptions</code>.
     * Include information related to the use of the voucher (all types)
     * @alias module:model/ResponseCheckMultipleSchemaDataInnerRedemptions
     */
    constructor() { 
        
        ResponseCheckMultipleSchemaDataInnerRedemptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseCheckMultipleSchemaDataInnerRedemptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseCheckMultipleSchemaDataInnerRedemptions} obj Optional instance to populate.
     * @return {module:model/ResponseCheckMultipleSchemaDataInnerRedemptions} The populated <code>ResponseCheckMultipleSchemaDataInnerRedemptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseCheckMultipleSchemaDataInnerRedemptions();
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseCheckMultipleSchemaDataInnerRedemptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseCheckMultipleSchemaDataInnerRedemptions</code>.
     */
 ...
 */
ResponseCheckMultipleSchemaDataInnerRedemptions.prototype['redeem_sku_codes'] = undefined;

/**
 * Actual redemption value of voucher type = conditional
 * @member {Number} redemption_value
 */
ResponseCheckMultipleSchemaDataInnerRedemptions.prototype['redemption_value'] = undefined;

/**
 * @member {module:model/ResponseCheckMultipleSchemaDataInnerRedemptionsUsedStore} used_store
 */
ResponseCheckMultipleSchemaDataInnerRedemptions.prototype['used_store'] = undefined;

/**
 * Date voucher marked as used in case the voucher has been redeemed. Format (YYYY-MM-DD HH:MM:SS)
 * @member {String} used_date
 */
ResponseCheckMultipleSchemaDataInnerRedemptions.prototype['used_date'] = undefined;

/**
 * Bill number for which voucher used/reserved
 * @member {String} bill_number
 */
ResponseCheckMultipleSchemaDataInnerRedemptions.prototype['bill_number'] = undefined;
...
export default ResponseCheckMultipleSchemaDataInnerRedemptions;
