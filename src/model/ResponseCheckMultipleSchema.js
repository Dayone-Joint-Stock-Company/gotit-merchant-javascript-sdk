...
import ResponseCheckMultipleSchemaDataInner from './ResponseCheckMultipleSchemaDataInner';
...
class ResponseCheckMultipleSchema {
    /**
     * Constructs a new <code>ResponseCheckMultipleSchema</code>.
     * @alias module:model/ResponseCheckMultipleSchema
     */
    constructor() { 
        
        ResponseCheckMultipleSchema.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseCheckMultipleSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseCheckMultipleSchema} obj Optional instance to populate.
     * @return {module:model/ResponseCheckMultipleSchema} The populated <code>ResponseCheckMultipleSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseCheckMultipleSchema();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ResponseCheckMultipleSchemaDataInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseCheckMultipleSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseCheckMultipleSchema</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ResponseCheckMultipleSchemaDataInner.validateJSON(item);
            };
        }
 ...
 */
ResponseCheckMultipleSchema.prototype['success'] = undefined;

/**
 * Result code if failed. In case of successful request: value is null
 * @member {String} return_code
 */
ResponseCheckMultipleSchema.prototype['return_code'] = undefined;

/**
 * Message notification in English
 * @member {String} message_en
 */
ResponseCheckMultipleSchema.prototype['message_en'] = undefined;

/**
 * Message notification in Vietnamese
 * @member {String} message_vi
 */
ResponseCheckMultipleSchema.prototype['message_vi'] = undefined;

/**
 * Detail items of voucher, if result is failed, response will return the first voucher code which is invalid
 * @member {Array.<module:model/ResponseCheckMultipleSchemaDataInner>} data
 */
ResponseCheckMultipleSchema.prototype['data'] = undefined;
...
export default ResponseCheckMultipleSchema;
